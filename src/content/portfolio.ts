...
function createCopy(locale: Locale) {
  ...
  return {
    ...
    home: {
      ...
      orientationItems: [
        { title: m.home_orientation_build_title({}, opt), body: m.home_orientation_build_body({}, opt) },
        { title: m.home_orientation_method_title({}, opt), body: m.home_orientation_method_body({}, opt) },
        { title: m.home_orientation_ai_title({}, opt), body: m.home_orientation_ai_body({}, opt) },
      ],
      orientationAction: m.home_orientation_action({}, opt),
